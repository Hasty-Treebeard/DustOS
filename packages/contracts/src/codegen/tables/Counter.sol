...
library Counter {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "dustos", name: "Counter", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462647573746f730000000000000000436f756e746572000000000000000000);
