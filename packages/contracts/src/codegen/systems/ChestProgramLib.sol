...
// equivalent to WorldResourceIdLib.encode({ typeId: RESOURCE_SYSTEM, namespace: "dustos", name: "ChestProgram" }))
ChestProgramType constant chestProgram = ChestProgramType.wrap(
  0x7379647573746f730000000000000000436865737450726f6772616d00000000
);
